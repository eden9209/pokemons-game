...
public class CL_Agent {
	...
	//	private long _key;
		...
		private long _sg_dt;
		private List <node_data> Track;
		private Point3D PokPos;
		...
		/**
		 * initializing agents from json string
		 * @param agent_json the json string
		 */
		public void initJson (String agent_json) {
			try {
				JSONObject line = new JSONObject(agent_json);
...
//		}
		...
		public void setPokPos(Point3D pos) {
			this.PokPos = new Point3D(pos);
		}
